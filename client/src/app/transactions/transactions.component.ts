...
export class TransactionsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.uploadService.uploadChanges$
      .pipe(concatMap(() => this.transactionsService.getAll()))
      .subscribe(transactions => {
        this.transactions$.next(transactions);
      });
    this.updateGrid$
      .pipe(concatMap(() => this.calculateSum('amount')))
      .subscribe(sum => {
  ...
  onCellValueChanged(cellValue) {
    ...
    this.transactionsService
      .patch(cellValue.data.id, transaction)
